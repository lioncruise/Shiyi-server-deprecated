...
module.exports = [{
  ...
  note: [
          ...
          '4.可以使用 lastActionCreatedAt(时间戳) lastActionId(Action.id) 两个参数返回 创建时间和某一记录之后的Action记录，没有会返回空数组。两个参数最好不要一起使用。',
          '5.文档中4的demo并没有展示很好，这是因为文档生成的数据库数据是同时写入数据库的，并不存在时间上的区别',
          ],
  requests: [
    {
      method: 'get',
    ...
    {
      method: 'get',
      url: '/getActions?lastActionCreatedAt=1451123382',
    },
  ],
},
];
